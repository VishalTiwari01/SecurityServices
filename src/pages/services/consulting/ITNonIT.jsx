...
import download from "../../../assets/it/download.jpeg";
import OIP from "../../../assets/it/OIP.jpeg";

const ITNonIT = () => {
  const [selected, setSelected] = useState("IT & Non IT");

  const selectedData = recruitmentData.find(
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="flex-1 p-6">
        ...
        {/* Image Cards: Responsive column layout */}

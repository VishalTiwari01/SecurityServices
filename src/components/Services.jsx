...
const Services = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-amber-900">
      <div>
        <span className="flex font-extrabold text-xl text-black-600">What we Offer</span>
        ...
        {cards.map((card, index) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <Link to={card.link}>
                <button className="bg-orange-500 text-white px-4 py-2 rounded hover:bg-orange-600 transition cursor-pointer">
                  Read More
                </button>
              </Link>
            </div>
